...
// Fetch complaints that match the officer's municipality (no date filter)
$sql_complaints = "SELECT * FROM complaints WHERE municipality = ?";
$stmt_complaints = $conn->prepare($sql_complaints);
$stmt_complaints->bind_param("s", $officer_municipality);  // Bind officer's municipality
...
<body>
                ...
                <table class="table table-striped" id="allTicketsTable">
                    ...
                    <tbody>
                        ...
                        if ($result_complaints->num_rows > 0) {
                            ...
                            echo "<tr><td colspan='11'>No tickets found for this municipality</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
    ...
    <script>
        // Initialize DataTable for allTicketsTable
        const allTicketsTable = new simpleDatatables.DataTable("#allTicketsTable");
    </script>
</body>
</html>
