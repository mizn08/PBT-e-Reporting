...
// Fetch complaints that match the officer's municipality and were created in the last 7 days
$sql_complaints = "SELECT * FROM complaints WHERE municipality = ? AND DATE(time_created) >= ?";
$stmt_complaints = $conn->prepare($sql_complaints);
$stmt_complaints->bind_param("ss", $officer_municipality, $seven_days_ago);  // Bind officer's municipality and date range
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="table-container">
                <table class="table table-striped" id="weeklyTicketsTable">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        if ($result_complaints->num_rows > 0) {
                            ...
                            echo "<tr><td colspan='11'>No tickets found for this week</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
    ...
    <script>
        // Initialize DataTable for weeklyTicketsTable
        const weeklyTicketsTable = new simpleDatatables.DataTable("#weeklyTicketsTable");
    </script>
</body>
</html>
