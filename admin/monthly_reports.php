...
// Fetch tickets from the complaints table for the current month
$sql = "SELECT * FROM complaints WHERE MONTH(time_created) = ? AND YEAR(time_created) = ?";
